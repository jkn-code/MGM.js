...
```javascript
pics: {
        p1: "Images/unit.png", // задать изображение из файла
        p2: { picName: 'p1', x: 50, y: 40, width: 20, height: 30, }, // задать изображение из части файла, который указан в этом же объекте
        p3: { object: 'space', picName: 'star', x: 1551, y: 263, width: 27, height: 33, }, // задать изображение из части файла, который указан другому объекту, и если у того объекта несколько изображений в `pics`
        p4: { object: 'sceneGame', x: 1551, y: 263, width: 27, height: 33, }, // задать изображение из части файла, который указан другому объекту, и если у того объекта одно изображение в `pic`
    },
```
